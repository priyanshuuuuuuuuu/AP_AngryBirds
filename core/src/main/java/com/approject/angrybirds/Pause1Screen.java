...
public class Pause1Screen extends ScreenAdapter implements Serializable {
    ...
    public Pause1Screen(AngryBirds game, Level1Screen level1Screen, GameState gamestate) {
        this.game = game;

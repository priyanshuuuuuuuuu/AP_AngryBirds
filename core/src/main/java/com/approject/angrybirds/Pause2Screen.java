...
public class Pause2Screen extends ScreenAdapter implements Serializable {
    ...
    private final Level2Screen level2Screen;
    ...
    public Pause2Screen(AngryBirds game, Level2Screen level2Screen, GameState gamestate) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        if (resumeButtonBounds.contains(touchPos.x, touchPos.y)) {
            ...
            if (Gdx.input.isTouched()) {
                game.setScreen(level2Screen); // Resume the game
            }
        } else {
        ...
        if (restartButtonBounds.contains(touchPos.x, touchPos.y)) {
            ...
            if (Gdx.input.isTouched()) {
                ...
                game.setScreen(new Level2Screen(game)); // Restart the level
            }
        } else {

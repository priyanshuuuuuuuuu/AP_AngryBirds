...
//    private Viewport viewport;// Second RedBird
...
//
//
//    public Level2Screen(AngryBirds game, GameState gameState) {
//        this.game = game;
...
//
//        float groundHeight = 1.0f; // Set ground slightly above the bottom (in Box2D units)
//
//        createEdgeBoundary(0, groundHeight, screenWidth, groundHeight); // Ground boundary
//        createEdgeBoundary(0, 0, 0, screenHeight); // Left boundary
//        createEdgeBoundary(0, screenHeight, screenWidth, screenHeight); // Top boundary
//        createEdgeBoundary(screenWidth, screenHeight, screenWidth, 0); // Right boundary
//    }
//
//
...
//        slingStartPosition = new Vector2(2.7f, 2.5f);
...
//        slingShot = new SlingShot(batch, 230, 105);
...
//        kingPig = new KingPig(batch, new Vector2(1610 / 100f, 500/ 100f), world);
...
////        groundBodyDef.position.set(0, 140 / 100f); // Set Y position for the ground (adjust as needed)
////
...
//
//                // Check if the collision involves a GlassBlock and a Bird
//                if ((userDataA instanceof GlassBlock && userDataB instanceof Bird) ||
//                    (userDataA instanceof Bird && userDataB instanceof GlassBlock)) {
//
//                    GlassBlock glassBlock = userDataA instanceof GlassBlock ? (GlassBlock) userDataA : (GlassBlock) userDataB;
//                    glassBlock.destroy();
//                }
//            }
//
...
//            // Check collision with both MinionPigs and KingPig
//            if (isPigHit(bird, minionPig) || isPigHit(bird, kingPig)) {
...
//        float pigHalfWidth = pig.PIG_WIDTH / 2 / 100f;
//        float pigHalfHeight = pig.PIG_HEIGHT / 2 / 100f;
...
////        isPaused = true;
////        game.setScreen(new PauseScreen(game, , gameState));  // Switch to pause screen
////    }
//
...
//        squareGlassBlock.dispose();
//        kingPig.dispose();
//        squareGlassBlock1.dispose();
//
//    }
//}
